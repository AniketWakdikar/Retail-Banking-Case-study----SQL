...
⦁	Select unique occupation from customer table

⦁	Sort accounts according to current balance 

⦁	Find the Date of Birth of customer name ‘Ramesh’

⦁	Add column city to branch table 

⦁	Update the mname and lname of employee ‘Bella’ and set to ‘Karan’, ‘Singh’ 

⦁	Select accounts opened between '2012-07-01' AND '2013-01-01'

⦁	List the names of customers having ‘a’ as the second letter in their names 


⦁	Find the lowest balance from customer and account table


⦁	Give the count of customer for each occupation
...
⦁	Select the details of the employee who work either for department ‘loan’ or ‘credit’
⦁	Write a query to display the customer number, customer firstname, account number for the customer’s who are born after 15th of any month.

⦁	Write a query to display the customer’s number, customer’s firstname, branch id and balance amount for people using JOIN.
⦁	Create a virtual table to store the customers who are having the accounts in the same city as they live
⦁	A. Create a transaction table with following details 
...
⦁	Write a query to display the details of customer with second highest balance 

⦁	Take backup of the databse created in this case study
